...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Isi Data bimbel.</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <form action="bimbel-proses.php" method="post" enctype="multipart/form-data">
    <div class="w3-section">
        <label>ID bimbel</label>
        <input class="w3-input w3-border" type="text" name="idBimbel" required>
      </div>
      <div class="w3-section">
        <label>Image</label>
        <input class="w3-input w3-border" type="file" name="imgBimbel" required>
      </div>
      <div class="w3-section">
        <label>Nama bimbel</label>
        <input class="w3-input w3-border" type="text" name="namaBimbel" required>
      </div>
      <div class="w3-section">
        <label>Deskripsi</label>
        <input class="w3-input w3-border" type="text" name="deskripsi" required>
      </div>
        <div class="w3-section">
        <label>idMateri</label>
